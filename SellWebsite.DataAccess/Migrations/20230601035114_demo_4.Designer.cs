...
namespace SellWebsite.DataAccess.Migrations
{
    ...
    [Migration("20230601035114_demo_4")]
            ...
            modelBuilder.Entity("SellWebsite.Models.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author = "TranPhuDat",
                            CreatedDate = new DateTime(2023, 6, 1, 10, 51, 14, 615, DateTimeKind.Local).AddTicks(370),
                            ...
                            Price = 500000m,
                            Title = "Glint",
                            UpdatedDate = new DateTime(2023, 6, 1, 10, 51, 14, 615, DateTimeKind.Local).AddTicks(381)
                        });
                });
